About pyiron_continuum-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyiron_continuum-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyiron_continuum-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyiron_continuum
# for installing globally
pixi global install pyiron_continuum
```
...
It is possible to list all of the versions of `pyiron_continuum` available on your platform:
...
```
pixi search pyiron_continuum --channel conda-forge
```
